...
'''
PROBLEM 0. Andres Lopez, Homework 7, Professor Nemane, CS106 009
'''
...
indefart = ['a', 'an']
defart = ['the']
print('CantoXII frequency of "a" and "an": ' + str(litCricFriend(indefart, cantoXII)))
print('The Bells frequency of "a" and "an": ' + str(litCricFriend(indefart, theBells)))
print('CantoXII frequency of "the": ' + str(litCricFriend(defart, cantoXII)))
print('The Bells frequency of "the": ' + str(litCricFriend(defart, theBells)))
...
'''
The results show that Poe uses 'a' and 'an' more frequently than Canto does and that Poe
also uses 'the' more frequently than Neruda.
'''
